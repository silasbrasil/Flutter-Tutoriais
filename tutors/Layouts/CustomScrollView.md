...
- __childAspectRatio__: Essa é a propriedade é mais interessante, é ela que define o tamanho da célula do grid. Até agora vimos como calcular a largura e o espaçamento de cada célula do grid, mas o tamanho aparece como? É justamente o _childAspectRatio_ que calcula isso. Baseado na razão dada. Ou seja, se a razão for 4, então teremos a lagura 4 vezes maior que a altura. Se a razão for 0.5 então teremos a altura com o dobro da largura.
